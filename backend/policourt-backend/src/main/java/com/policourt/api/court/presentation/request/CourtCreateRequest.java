...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Datos para crear una nueva pista")
public class CourtCreateRequest {
    ...
    @Schema(description = "URL de la imagen", example = "https://example.com/court.jpg")
    private String imgUrl;

    @NotNull(message = "El precio por hora es obligatorio")
    @DecimalMin(value = "0.0", message = "El precio debe ser mayor o igual a 0")
    @Schema(description = "Precio por hora", example = "25.00")
    ...
    @Schema(description = "Tipo de superficie", example = "HARD")
    private CourtSurfaceEnum surface;

    @Schema(description = "Lista de slugs de deportes asociados", example = "[\"tennis\", \"padel\"]")
