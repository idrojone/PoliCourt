...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Solicitud para actualizar una reserva de tipo training")
public class BookingTrainingUpdateRequest {
    ...
    @Schema(description = "Slug del club")
    @NotBlank(message = "clubSlug es obligatorio")
