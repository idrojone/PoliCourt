...
/**
 * Controlador REST para la gestión de reservas (alquileres, clases y
 * entrenamientos).
 */
@RestController
...
public class BookingController {
     ...
     */
    @Operation(summary = "Crear una nueva reserva", description = "Crea una nueva reserva genérica para una pista.")
    @PostMapping
     ...
     */
    @Operation(summary = "Recuperar reserva por slug", description = "Recupera los detalles de una reserva específica por su slug.")
    @GetMapping("/{slug}")
    ...
    /**
     * Busca alquileres con filtros opcionales y paginación.
     */
    @Operation(summary = "Buscar reservas de alquiler", description = "Recupera reservas de tipo RENTAL con filtros opcionales y paginación.")
    @GetMapping("/rentals")
    public ResponseEntity<ApiResponse<Page<BookingResponse>>> getRentals(
            @RequestParam(required = false) String courtSlug,
            ...
            @RequestParam(defaultValue = "startTime_desc") String sort) {
        return getBookingsByType(
                BookingType.RENTAL, courtSlug, organizerUsername, status, isActive,
                startTime, endTime, minPrice, maxPrice, q, page, limit, sort,
     ...
     */
    @Operation(summary = "Crear una reserva de alquiler", description = "Crea una nueva reserva de tipo RENTAL. El título se genera automáticamente y el precio se calcula según el tiempo reservado × precio por hora de la pista.")
    @PostMapping("/rentals")
     ...
     */
    @Operation(summary = "Buscar clases", description = "Recupera reservas de tipo CLASS con filtros opcionales y paginación.")
    @GetMapping("/classes")
    public ResponseEntity<ApiResponse<Page<BookingResponse>>> getClasses(
            @RequestParam(required = false) String courtSlug,
            @RequestParam(required = false) String organizerUsername,
            @RequestParam(required = false) BookingStatus status,
            @RequestParam(required = false) Boolean isActive,
            ...
            @RequestParam(defaultValue = "startTime_desc") String sort) {
        return getBookingsByType(
                BookingType.CLASS, courtSlug, organizerUsername, status, isActive,
                startTime, endTime, minPrice, maxPrice, q, page, limit, sort,
     ...
     */
    @Operation(summary = "Crear una clase", description = "Crea una nueva reserva de tipo CLASS.")
    @PostMapping("/classes")
    ...
    /**
     * Busca entrenamientos con filtros opcionales y paginación.
     */
    @Operation(summary = "Buscar entrenamientos", description = "Recupera reservas de tipo TRAINING con filtros opcionales y paginación.")
    @GetMapping("/trainings")
    public ResponseEntity<ApiResponse<Page<BookingResponse>>> getTrainings(
            @RequestParam(required = false) String courtSlug,
            @RequestParam(required = false) String organizerUsername,
            @RequestParam(required = false) BookingStatus status,
            @RequestParam(required = false) Boolean isActive,
            ...
            @RequestParam(defaultValue = "startTime_desc") String sort) {
        return getBookingsByType(
                BookingType.TRAINING, courtSlug, organizerUsername, status, isActive,
                startTime, endTime, minPrice, maxPrice, q, page, limit, sort,
     ...
     */
    @Operation(summary = "Crear un entrenamiento", description = "Crea una nueva reserva de tipo TRAINING.")
     ...
     */
    @Operation(summary = "Actualizar el estado de una reserva", description = "Actualiza el estado (CONFIRMED, PENDING, CANCELLED, COMPLETED) de una reserva específica.")
     ...
     * @return Respuesta con la reserva actualizada.
     */
    @Operation(summary = "Actualizar el estado activo de una reserva", description = "Actualiza el campo isActive de una reserva. Útil para soft-delete.")
     ...
     */
    @Operation(summary = "Toggle del estado activo de una reserva", description = "Invierte el valor actual de isActive de la reserva.")
     ...
     */
    @Operation(summary = "Actualizar un alquiler", description = """
     ...
     */
    @Operation(summary = "Actualizar una clase", description = """
     ...
     */
    @Operation(summary = "Actualizar un entrenamiento", description = """
    ...
    /**
     * Método auxiliar para recuperar reservas filtradas por tipo con filtros y
     * paginación.
     */
    private ResponseEntity<ApiResponse<Page<BookingResponse>>> getBookingsByType(
            BookingType type,
            String courtSlug,
        ...
        var pageResult = bookingService
                .searchByType(
                        type, courtSlug, organizerUsername, status, isActive,
                        startTime, endTime, minPrice, maxPrice, q, page, limit, sort)
                .map(bookingDtoMapper::toResponse);
        return ResponseEntity.ok(ApiResponse.success(pageResult, successMessage));
    }
